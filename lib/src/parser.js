...
var react_native_eventemitter_1 = __importDefault(require("react-native-eventemitter"));
var Parser = (function (_super) {
            ...
            if (curr === '\n' && next === '\n') {
                ...
                switch (event_1) {
                    ...
                    case 'delete':
                        ...
                        break;
                    default:
                        this.emit('error', new Error("Unknown event has received: " + event_1));
                        continue;
                }
            }
            offset++;
    ...
    return Parser;
}(react_native_eventemitter_1.default));
