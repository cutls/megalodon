...
import { type MegalodonInterface, type WebSocketInterface, NotImplementedError, ArgumentError, UnexpectedError } from './megalodon.js'
...
export default class Misskey implements MegalodonInterface {
    ...
    */
	 ...
	 */
	public async fetchAccessToken(_client_id: string | null, client_secret: string, session_token: string, _redirect_uri?: string): Promise<MisskeyOAuth.TokenData> {
		return this.client
	...
	// accounts
	// ======================================
	public async registerAccount(_username: string, _email: string, _password: string, _agreement: boolean, _locale: string, _reason?: string | null): Promise<Response<Entity.Token>> {
		return new Promise((_, reject) => {
			const err = new NotImplementedError('misskey does not support')
			reject(err)
		})
	...
	// accounts/bookmarks
	// ======================================
	public async getBookmarks(_options?: { limit?: number; max_id?: string; since_id?: string; min_id?: string }): Promise<Response<Array<Entity.Status>>> {
		return new Promise((_, reject) => {
			const err = new NotImplementedError('misskey does not support')
			reject(err)
		})
	...
	// ======================================
	public async getEndorsements(_options?: { limit?: number; max_id?: string; since_id?: string }): Promise<Response<Array<Entity.Account>>> {
		return new Promise((_, reject) => {
			const err = new NotImplementedError('misskey does not support')
			reject(err)
		})
	 ...
	 */
	public async getStatusContext(id: string, options?: { limit?: number; max_id?: string; since_id?: string }): Promise<Response<Entity.Context>> {
		let params = {
			noteId: id
		}
		if (options) {
	...
	public async uploadMedia(file: any, _options?: { description?: string; focus?: string }): Promise<Response<Entity.Attachment>> {
		...
		return this.client.post<MisskeyAPI.Entity.File>('/api/drive/files/create', formData, headers).then((res) => ({ ...res, data: MisskeyAPI.Converter.file(res.data) }))
	}
	...
	public async updateMedia(
		...
		return this.client.post<MisskeyAPI.Entity.File>('/api/drive/files/update', params).then((res) => ({ ...res, data: MisskeyAPI.Converter.file(res.data) }))
	}
	...
	// ======================================
	public async getScheduledStatuses(_options?: { limit?: number; max_id?: string; since_id?: string; min_id?: string }): Promise<Response<Array<Entity.ScheduledStatus>>> {
		return new Promise((_, reject) => {
			const err = new NotImplementedError('misskey does not support')
			reject(err)
		})
	 ...
	 */
	public async getPublicTimeline(options?: { only_media?: boolean; limit?: number; max_id?: string; since_id?: string; min_id?: string }): Promise<Response<Array<Entity.Status>>> {
		let params = {}
		if (options) {
	 ...
	 */
	public async getLocalTimeline(options?: { only_media?: boolean; limit?: number; max_id?: string; since_id?: string; min_id?: string }): Promise<Response<Array<Entity.Status>>> {
		let params = {}
		if (options) {
			if (options.only_media !== undefined) {
				params = Object.assign(params, {
	 ...
	 */
	public async getHomeTimeline(options?: { local?: boolean; limit?: number; max_id?: string; since_id?: string; min_id?: string }): Promise<Response<Array<Entity.Status>>> {
		let params = {
			withFiles: false
		}
		if (options) {
	 ...
	 */
	public async getConversationTimeline(options?: { limit?: number; max_id?: string; since_id?: string; min_id?: string }): Promise<Response<Array<Entity.Conversation>>> {
		let params = {
	...
	public async getLists(): Promise<Response<Array<Entity.List>>> {
		return this.client.post<Array<MisskeyAPI.Entity.List>>('/api/users/lists/list').then((res) => ({ ...res, data: res.data.map((l) => MisskeyAPI.Converter.list(l)) }))
	}
	...
	public async saveMarkers(_options?: { home?: { last_read_id: string }; notifications?: { last_read_id: string } }): Promise<Response<Entity.Marker>> {
		return new Promise((_, reject) => {
			const err = new NotImplementedError('misskey does not support')
			reject(err)
		})
	...
	public async readNotifications(_options: { id?: string; max_id?: string }): Promise<Response<Entity.Notification | Array<Entity.Notification>>> {
		return new Promise((_, reject) => {
	...
	public async search(
		...
		switch (options?.type) {
			...
			default: {
				...
				const [accounts, statuses, hashtags] = await Promise.all([this.search(q, newOptionAcct), this.search(q, newOptionStatus), this.search(q, newOptionHashtag)])
				return {
					...accounts,
					data: {
	...
	public async getInstance(): Promise<Response<Entity.Instance>> {
		...
		return this.client.post<MisskeyAPI.Entity.Stats>('/api/stats').then((res) => ({ ...res, data: MisskeyAPI.Converter.meta(meta, res.data) }))
	}
	...
	public async getInstanceTrends(_limit?: number | null): Promise<Response<Array<Entity.Tag>>> {
		return this.client.post<Array<MisskeyAPI.Entity.Hashtag>>('/api/hashtags/trend').then((res) => ({ ...res, data: res.data.map((h) => MisskeyAPI.Converter.hashtag(h)) }))
	}
	/**
	...
	// instance/directory
	// ======================================
	public async getInstanceDirectory(_options?: { limit?: number; offset?: number; order?: 'active' | 'new'; local?: boolean }): Promise<Response<Array<Entity.Account>>> {
		return new Promise((_, reject) => {
			const err = new NotImplementedError('misskey does not support')
			reject(err)
		})
	...
	public async getInstanceCustomEmojis(): Promise<Response<Array<Entity.Emoji>>> {
		return this.client.post<MisskeyAPI.Entity.APIEmoji>('/api/emojis').then((res) => ({ ...res, data: res.data.emojis.map((e) => MisskeyAPI.Converter.emoji(e)) }))
	}
