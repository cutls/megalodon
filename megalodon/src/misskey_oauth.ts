...
namespace MisskeyOAuth {
	...
	export class AppData {
		...
		static from(raw: AppDataFromServer) {
			return new AppData(raw.id, raw.name, raw.website, raw.redirect_uri, raw.client_id, raw.client_secret)
		}
	...
	export class TokenData {
		...
		static from(raw: TokenDataFromServer) {
			return new TokenData(raw.access_token, raw.token_type, raw.scope, raw.created_at, raw.expires_in, raw.refresh_token)
		}
