...
import type Streaming from './mastodon/web_socket.js'
import { type MegalodonInterface, NotImplementedError } from './megalodon.js'
...
export default class Mastodon implements MegalodonInterface {
	...
	public async createApp(
		...
		return this.client.post<MastodonOAuth.AppDataFromServer>('/api/v1/apps', params).then((res: Response<MastodonOAuth.AppDataFromServer>) => MastodonOAuth.toAppData(res.data))
	}
   ...
   */
	...
	public async getInstanceTrends(limit?: number | null): Promise<Response<Array<Entity.Tag>>> {
		...
		return this.client.get<Array<MastodonAPI.Entity.Tag>>('/api/v1/trends/tags', params).then((res) => {
			return Object.assign(res, {
				data: res.data.map((t) => MastodonAPI.Converter.tag(t))
			})
		})
