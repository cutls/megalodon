...
import type PleromaEntity from './entity.js'
...
namespace PleromaAPI {
	...
	export namespace Converter {
		export const decodeNotificationType = (t: PleromaEntity.NotificationType): MegalodonEntity.NotificationType | UnknownNotificationTypeError => {
			switch (t) {
		...
		export const encodeNotificationType = (t: MegalodonEntity.NotificationType): PleromaEntity.NotificationType | UnknownNotificationTypeError => {
			switch (t) {
