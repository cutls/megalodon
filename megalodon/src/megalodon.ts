...
export interface MegalodonInterface {
	 ...
	 */
	registerApp(client_name: string, options: Partial<{ scopes: Array<string>; redirect_uris: string; website: string }>): Promise<OAuth.AppData>
	 ...
	 */
	createApp(client_name: string, options: Partial<{ scopes: Array<string>; redirect_uris: string; website: string }>): Promise<OAuth.AppData>
	 ...
	 */
	getScheduledStatuses(options?: { limit?: number; max_id?: string; since_id?: string; min_id?: string }): Promise<Response<Array<Entity.ScheduledStatus>>>
	/**
	 ...
	 * @return Array of statuses.
	 */
	getPublicTimeline(options?: { only_media?: boolean; limit?: number; max_id?: string; since_id?: string; min_id?: string }): Promise<Response<Array<Entity.Status>>>
	/**
	 * View local timeline.
	 *
	 * @param options.only_media Show only statuses with media attached? Defaults to false.
	 ...
	 * @return Array of statuses.
	 */
	getLocalTimeline(options?: { only_media?: boolean; limit?: number; max_id?: string; since_id?: string; min_id?: string }): Promise<Response<Array<Entity.Status>>>
	/**
	 ...
	 * @return Array of statuses.
	 */
	getHomeTimeline(options?: { local?: boolean; limit?: number; max_id?: string; since_id?: string; min_id?: string }): Promise<Response<Array<Entity.Status>>>
	/**
	 * View list timeline.
	 *
	 ...
	 * @return Array of statuses.
	 */
	getConversationTimeline(options?: { limit?: number; max_id?: string; since_id?: string; min_id?: string }): Promise<Response<Array<Entity.Conversation>>>
	/**
	 ...
	 * @return PushSubscription.
	 */
	updatePushSubscription(data?: { alerts: { follow?: boolean; favourite?: boolean; reblog?: boolean; mention?: boolean; poll?: boolean } } | null): Promise<Response<Entity.PushSubscription>>
	/**
	 ...
	 * @return Array of accounts.
	 */
	getInstanceDirectory(options?: { limit?: number; offset?: number; order?: 'active' | 'new'; local?: boolean }): Promise<Response<Array<Entity.Account>>>
 ...
 */
const generator = (sns: 'mastodon' | 'pleroma' | 'misskey', baseUrl: string, accessToken: string | null = null, userAgent: string | null = null): MegalodonInterface => {
	switch (sns) {
		case 'pleroma': {
